...
def admin(driver, url):
    ...
    try:
        ...
        upload_file = driver.find_element(By.ID, 'upload-image').click()
        upload_file.click()
        sleep_timeout_short()
    ...
    try:
        ...
        sleep_timeout_medium()
        driver.find_element(By.ID, 'kpi-label-1').click()
        sleep_timeout_medium()
        driver.find_element(By.ID, 'kpi-label-2').click()
        sleep_timeout_medium()
        driver.find_element(By.ID, 'kpi-label-3').click()
        sleep_timeout_medium()
        driver.find_element(By.ID, 'kpi-label-4').click()
        sleep_timeout_medium()
        driver.find_element(By.ID, 'submit').click()
        sleep_timeout_long()
        # Search By Name
